...
Keyboard.Key.SELECT = 9;//tab
Keyboard.Key.START = 13;//回车

Keyboard.Event = {};
Keyboard.Event.KEY_PRESSED = 'Keyboard.Event.KEY_PRESSED';  //按键按下
Keyboard.Event.KEY_RELEASED = 'Keyboard.Event.KEY_RELEASED';  //按键释放
